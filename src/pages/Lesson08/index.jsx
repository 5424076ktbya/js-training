...
const convertData = (input) => {  //タグをソート
  for (const item of input) {
    item.tags.sort();
  }

  const tagSet = new Set(); //タグ一覧を作る
  for (const item of input) {
  ...
  for (const item of input) { //ペアを数える
  ...
  const nodeSet = new Set();  //nodes を作る
